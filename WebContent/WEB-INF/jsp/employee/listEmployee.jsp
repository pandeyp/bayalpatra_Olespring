	...
	<table class="gtable">
		...
		<c:forEach items="${model.employeeList}" var="emp">
			...
			<%-- 	<td><c:out value="${emp.mobile}"></c:out></td> --%>
				...
				<td><a
					href="../employee/editEmployee.html?edit=<c:out value="${emp.id}"/>"><img src = "../resources/img/edit_icon.png">   Edit</a>
					/  <a href="../employee/deleteEmployee.html?delete=<c:out value="${emp.id}"/>" onclick="return confirm('Are you sure you want to delete?');"><img src = "../resources/img/delete.png">  Delete</a></td>
			</tr>
		</c:forEach>
	</table>
</div>
